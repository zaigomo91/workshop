...
Next week's session will be about version control and project management with Git and Github. Please download and install [Github desktop](https://desktop.github.com/) on your machine! See you next week! `r emo::ji("computer")`
